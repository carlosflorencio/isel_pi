...
module.exports.playlistExists = function (req, res, next) {
    ...
    playlistService.getPlaylistById(playlistId, (err, playlist) => {
...
module.exports.accessToPlaylist = function(req, res, next) {
    ...
    inviteService.getInvitationByPlaylistAndUser(req.user.email, req.playlist.id, (err, invite) => {
        if(err) return next(err)
...
module.exports.playlistName = function(req, res, next) {
    ...
    playlistService.findUserPlaylistByName(req.user.id, name, (err, pl) => {
        if(err) return next(err)
